...
export default function HeroSection() {
  ...
  return (
    <div   id="home" className="md:p-32 py-12 px-4 lg:py-16 md:px-16 mx-auto flex flex-col-reverse items-center md:flex-row">
        ...
        <div className="text-white md:w-2/3 leading-relaxed lg:pt-10 md:pr-10">
          ...
          <p id="home" className="py-4">
            A passionate full-stack web developer and designer with a strong foundation
            ...
            dynamic world of web development, graphic design and software development.
            Let's build something remarkable together.

          </p>


          <div className="flex flex-row justify-center items-center mt-7 bg-gray-800 py-2 md:bg-transparent">
            <a href="" target="_blank" rel="noopener noreferrer">
              <button className="py-1 md:py-2  px-4 rounded-full mr-4">Hire Me </button>
            </a>
            <a
